    ...
    return (
        <div className="mx-auto my-40 h-[418px] w-[400px]">
            <form className="flex flex-col justify-center gap-5 border-2 border-teal-800 rounded-md"
                ...
                <input className="m-2 pl-2 text-white text-black border rounded-md bg-black" type="email" id="email"
                       name="email"
                       placeholder="Enter your email"/>
                <input className="m-2 pl-2 text-white text-black border rounded-md bg-black" type="password"
                       id="password"
