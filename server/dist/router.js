...
router.get('/auth/google/callback', passport_1.default.authenticate('google'), UserController_1.default.authCallback);
router.get('/twitter', passport_1.default.authenticate('twitter'));
router.get('/auth/twitter/callback', passport_1.default.authenticate('twitter'), UserController_1.default.authCallback);
